...
?>
<h3 style="margin-top: 1%; margin-bottom: 1%"> Laporan Kehadiran Aktiviti </h3>
...
<h3 style="margin-top: 1%; margin-bottom: 1%">
    <?= $ma['nama_aktiviti'] ?><br>
...
SELECT *, ahli.nokp
 ...
 and id_aktiviti = '".$_GET['id_aktiviti']."'
 $tambahan
 ORDER BY ahli.nama ";
...
<?php 
$bg_color = '#CBC3E3';
echo "<body style='background-color: $bg_color; margin: 0;'>";
?>
<?php